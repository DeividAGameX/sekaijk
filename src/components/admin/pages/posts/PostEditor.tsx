...
function MenuBar() {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center bg-primary gap-2 p-2 sticky top-1 z-10 md:bg-transparent md:flex-row md:justify-between">
            ...
            <div className="flex gap-2 flex-wrap justify-center bg-primary p-1 rounded-lg">
                <Dropdown
                    ...
                    >
                        {
                            (
                                headers.find((e) =>
                                    editor.isActive("heading", {level: e.value})
                                ) || {titulo: "Párrafo"}
                            ).titulo
                        }
                    </Button>
    ...
    return (
        <EditorProvider
            ...
            editorContainerProps={{
                className: "postEditor w-full flex-1 flex pt-0 pb-4 px-4",
            }}
        />
    );
}
